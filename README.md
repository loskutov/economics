...
выражается в полезном эффекте, удовлетворяющем потребности человека.
...
**Экономическое содержание собственности** — не интересует дарение, воровство,
наследование, завоевание. *Только производство!*  
Разделение объектов на факторы, условия и средства производства с одной стороны
и потребительские блага с другой.

1. Собственность не вещь и не отношение к вещам — эти отношения имеют
    социально-экономическое содержание/формы
...
Права собственности в современном обществе понимаются как санкционированное обществом
(закономи, традициями, адм распоряжениями) поведенческие отношения между людьми
...
**Экономическая система** — совокупность взаимосвязанных и определённым образом упорядоченных
элементов экономики
...
**Рынок** — способ взаимодействия производителя с потребителем,
основанный на децентрализованном механизме ценовых сигналов
...
**Закон спроса**: при прочих равных чем ниже цена, тем выше величина спроса.

Существуют исключения:
* (некоторые) товары первой необходимости
* (некоторые) дорогостоящие, престижные товары (эффект сноба)
...
**Объём предложения** — максимальное количество товара,
подготовленного для продажи за данный период времени при данных условиях
...
**Общая полезность** — удовлетворение, которое экономический субъект получает
от потребления данного набора благ

**Предельная полезность** — полезность дополнительной единицы блага при прочих равных условиях

**Закон убывающей предельной полезности** — по мере потребления новых единиц данного блага
...
**Эффект замещения** — потребитель покупает больше товара, цена на который снизилась,
заменяя им тот, на который она поднялась

**Принцип максимальной общей полезности** — приобретая набор различных благ, необходимо
распределить доход так, чтобы предельная полезность на единицу цены одного блага
была равна оной другого блага
